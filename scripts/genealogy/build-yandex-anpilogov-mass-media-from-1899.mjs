...
const tracker = {
  ...
  validation: {
    ...
    cloudEvidenceVerifiedAt: "2026-09-13",
    correctedTargetBlobPath: targetFragment.path,
    correctedTargetBlobBytes: targetBytes.length,
    correctedTargetBlobSizeVerified: true,
