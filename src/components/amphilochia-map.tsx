  ...
  return (
    <figure className="amphilochia-map">
      ...
      <p className="amphilochia-map-note">
        Современный город до 1908 года назывался Карвасарас, а затем получил имя
        исторической области. Для древнего Аргоса оставлена координатная область:
        академические справочники расходятся в точной локализации.
      </p>
    </figure>
  );
}
