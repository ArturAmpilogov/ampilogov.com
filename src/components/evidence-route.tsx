...
const routes: Record<string, { eyebrow: string; title: string; stops: RouteStop[]; note: string }> = {
  overview: {
    ...
    note: "Сплошная линия соединяет историю имени и документированные очаги фамилии. Пунктиром отмечены направления дальнейшего поиска между курско-орловским ядром, Таврией и поздними ветвями.",
  },
  "amphilochius-name": {
  ...
  taurida: {
    ...
    note: "Пунктиром отмечено направление поиска документов, связывающих северные и таврические семейные группы.",
  },
  crimea: {
