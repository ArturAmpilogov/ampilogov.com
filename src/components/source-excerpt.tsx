...
const excerpts: Record<string, SourceExcerptDefinition> = {
  ...
  "nikonov-ampilogov": {
    eyebrow: "Словарная статья",
    title: "Как Никонов объяснял форму «Ампилогов»",
    transcription: "«Ампилогов — отчество от формы Ампилог из канонического м. л. и. Амфилохий».",
    citation: "В. А. Никонов. «Опыт словаря русских фамилий. II» // Этимология. 1971. М.: Наука, 1973. С. 263.",
    image: {
      src: "/archive/evidence/publications/ruslang/etymology-1971/pages/0263.jpg",
      width: 1005,
      height: 1604,
      viewBox: [42, 286, 920, 128],
      focus: [
        [90, 309, 868, 34],
        [42, 342, 558, 33],
      ],
