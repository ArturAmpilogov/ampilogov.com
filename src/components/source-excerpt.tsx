...
const excerpts: Record<string, SourceExcerptDefinition> = {
  ...
  "onfilogovo-tver-1540": {
    ...
    transcription: "«Къ тому жъ селу деревни: дер. Онфилогово: 4 дв.; пашни въ полѣ 30 четьи, сѣна 30 коп.» — первая из шести деревень села Никольское Свечино, за вдовой Стефанидой Юрловой.",
